          ...
          {STAGES.map(stage => {
            ...
            return (
              ...
              >
                ...
                {/* Cards */}
                <div style={{ flex: 1, overflowY: 'auto', display: 'flex', flexDirection: 'column', gap: 6, padding: '8px 0', background: 'rgba(255,255,255,.01)', border: '1px solid var(--border)', borderTop: 'none', borderRadius: '0 0 8px 8px', padding: '8px' }}>
                  {stageDeals.map(deal => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {contact && (
                          <div style={{ fontSize: 11, color: 'var(--text-3)', marginBottom: 6 }}>{contact.name}</div>
                        )}
